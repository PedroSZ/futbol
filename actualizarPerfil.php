    ...
    <div id="contenedor">
        ...
        <section>
            <article id="fondo" style="width: 600px; height:auto; ">
               ...
               <form method="post" style="width: 500px;"  action="modulos/mdl_ActualizarEstudiantes.php" id="frm_ActualizarEstudiantes" >
...
echo '
  <tr>
    ...
    <td>
      <p><input name="codigo:" type="text" placeholder="Ingresa la CURP" id ="codigo" value="'.$alumnos["curp"].'"></p>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <p><input name="nombre" type="text" placeholder="Ingresa el Nombre" id ="nombre" value="'.$alumnos["nombre"].'"></p>
    </td>
  </tr>
  <tr>
    <td style="text-align: right;">
    ...
    <td>
      <p><input name="apellidos" type="text" placeholder="Ingresa los Apellidos" id ="apellidos" value="'.$alumnos["apellidos"].'"></p>
    </td>
  </tr>
  <tr>
    <td style="text-align: right;">
    ...
    <td>
      <p><input name="carrera" type="text" placeholder="Ingresa la carrera" id ="carrera" value="'.$alumnos["carrera"].'"></p>
    </td>
  </tr>
  <tr>
    <td style="text-align: right;">
    ...
    <td>
      <p><input name="grado" type="text" placeholder="Ingresa el grado" id ="telefono" value="'.$alumnos["grado"].'"></p>
    </td>
    ...
    <td>
      <p><input name="grupo" type="text" placeholder="Ingresa el grupo" id ="grupo" value="'.$alumnos["grupo"].'"></p>
    </td>
  </tr>
