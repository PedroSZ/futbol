...
<html>
    ...
    <div id="contenedor">
        ...
        <section style="text-align: center; margin: 0 auto;">
            <article style="width: 600px; height:auto;text-align: center; margin: 0 auto;">
                 ...
                 <div class="datagrid">
                 <form method="post" action="modulos/mdl_AltaEnTaller.php" name="frm_AltaEnTaller" id="frm_AltaEnTaller" >
  ...
  if($talleres){
    ...
    foreach ($talleres as $taller) {
      ...
      <td style='text-align:center'><img width='30' height='30' src='imgs/elegir.png' onClick='consultar(\"".$taller['id']."\");'></td>
      </tr>";
    }
    echo "</table>";
  }
